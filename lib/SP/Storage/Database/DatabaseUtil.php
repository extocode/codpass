...
final class DatabaseUtil
{
    ...
    private readonly \SP\Storage\Database\DBStorageInterface $DBStorage;
     ...
     * @return bool
     */
    public function checkDatabaseTables(string $dbName)
    {
        try {
            $tables = implode(',', array_map(fn($value): string => '\'' . $value . '\'', self::$tables));
