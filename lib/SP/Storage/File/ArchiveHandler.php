 ...
 */
final readonly class ArchiveHandler
{
    public const COMPRESS_EXTENSION = '.tar.gz';

    private \SP\Core\PhpExtensionChecker $extensionChecker;

    private \SP\Storage\File\FileHandler $archive;
    ...
    public function __construct(string $archive, PhpExtensionChecker $extensionChecker)
    {
        ...
        $this->archive = new FileHandler($this->makeArchiveName($archive));
    }

    private function makeArchiveName(string $archive): string
    {
