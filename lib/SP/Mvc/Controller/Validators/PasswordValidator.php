 ...
 */
final readonly class PasswordValidator implements ValidatorInterface
{
    private \SP\DataModel\ItemPreset\Password $password;
    ...
    public static function factory(Password $password): self
    {
