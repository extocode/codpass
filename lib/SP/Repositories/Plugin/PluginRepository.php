...
final class PluginRepository extends Repository implements RepositoryItemInterface
{
     ...
     */
    public function create($itemData): \SP\Storage\Database\QueryResult
    {
        $query = /** @lang SQL */
     ...
     * @throws QueryException
     */
    public function toggleEnabled($id, $enabled): int
    {
        $queryData = new QueryData();
     ...
     * @throws QueryException
     */
    public function toggleEnabledByName($name, $enabled): int
    {
        $queryData = new QueryData();
     ...
     * @throws QueryException
     */
    public function toggleAvailable($id, $available): int
    {
        $queryData = new QueryData();
     ...
     * @throws QueryException
     */
    public function toggleAvailableByName($name, $available): int
    {
        $queryData = new QueryData();
     ...
     * @throws QueryException
     */
    public function resetById($id): int
    {
        $queryData = new QueryData();
