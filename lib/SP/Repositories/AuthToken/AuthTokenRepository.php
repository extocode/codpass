...
final class AuthTokenRepository extends Repository implements RepositoryItemInterface
{
     ...
     * @throws QueryException
     */
    public function refreshTokenByUserId($id, $token): int
    {
        $query = /** @lang SQL */
            'UPDATE AuthToken 
            SET token = ?,
     ...
     * @throws QueryException
     */
    public function refreshVaultByUserId($id, $vault, $hash): int
    {
        $query = /** @lang SQL */
            'UPDATE AuthToken 
            SET vault = ?,
     ...
     * @throws QueryException
     */
    public function getUserIdForToken($token): int|false
    {
        $queryData = new QueryData();
