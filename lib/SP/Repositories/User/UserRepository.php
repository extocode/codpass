...
final class UserRepository extends Repository implements RepositoryItemInterface
{
     ...
     * @throws QueryException
     */
    public function updatePassById($id, UpdatePassRequest $passRequest): int
    {
        $query = /** @lang SQL */
            'UPDATE User SET
            pass = ?,
     ...
     * @throws QueryException
     */
    public function updateMasterPassById($id, $pass, $key): int
    {
        $query = /** @lang SQL */
            'UPDATE User SET 
              mPass = ?,
     ...
     * @throws ConstraintException
     */
    public function updateLastLoginById($id): int
    {
        $queryData = new QueryData();
     ...
     * @throws QueryException
     */
    public function checkExistsByLogin($login): bool
    {
        $queryData = new QueryData();
     ...
     * @throws QueryException
     */
    public function updatePreferencesById($id, UserPreferencesData $userPreferencesData): int
    {
        $queryData = new QueryData();
