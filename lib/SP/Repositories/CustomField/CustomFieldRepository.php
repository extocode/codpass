...
final class CustomFieldRepository extends Repository implements RepositoryItemInterface
{
     ...
     * @throws ConstraintException
     */
    public function checkExists($itemData): bool
    {
        $query = /** @lang SQL */
            'SELECT id
    ...
    public function create($itemData): int
    {
        ...
        return (int) $this->db->doQuery($queryData)->getLastId();
    }
     ...
     * @throws ConstraintException
     */
    public function deleteCustomFieldData($itemId, $moduleId): int
    {
        $query = /** @lang SQL */
     ...
     * @throws ConstraintException
     */
    public function deleteCustomFieldDataForDefinition($id, $moduleId, $definitionId): int
    {
        $query = /** @lang SQL */
            'DELETE FROM CustomFieldData
            WHERE itemId = ?
     ...
     * @throws ConstraintException
     */
    public function deleteCustomFieldDefinitionData($definitionId): int
    {
        $queryData = new QueryData();
     ...
     * @throws ConstraintException
     */
    public function deleteCustomFieldDataBatch(array $ids, $moduleId): int
    {
        if ($ids === []) {
            return 0;
        }
     ...
     */
    public function getByIdBatch(array $ids): never
    {
        throw new RuntimeException('Not implemented');
    }
     ...
     */
    public function deleteByIdBatch(array $ids): never
    {
        throw new RuntimeException('Not implemented');
    }
     ...
     * @param $id int
     */
    public function checkInUse($id): never
    {
        throw new RuntimeException('Not implemented');
    }
     ...
     *
     */
    public function search(ItemSearchData $SearchData): never
    {
        throw new RuntimeException('Not implemented');
    }
     ...
     */
    public function checkDuplicatedOnUpdate($itemData): never
    {
        throw new RuntimeException('Not implemented');
    }
     ...
     * @param mixed $itemData
     */
    public function checkDuplicatedOnAdd($itemData): never
    {
        throw new RuntimeException('Not implemented');
    }
}
