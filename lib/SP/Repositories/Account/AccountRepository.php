...
final class AccountRepository extends Repository implements RepositoryItemInterface
{
     ...
     * @throws QueryException
     */
    public function incrementDecryptCounter($id): bool
    {
        $query = /** @lang SQL */
     ...
     * @throws QueryException
     */
    public function editRestore($historyId, $userId): bool
    {
        $query = /** @lang SQL */
            'UPDATE Account dst, 
     ...
     * @throws SPException
     */
    public function updateBulk($itemData): int
    {
        $queryAssignment = new QueryAssignment();
     ...
     * @throws QueryException
     */
    public function incrementViewCounter($id): bool
    {
        $queryData = new QueryData();
