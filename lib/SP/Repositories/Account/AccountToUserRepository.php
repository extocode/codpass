...
final class AccountToUserRepository extends Repository
{
     ...
     */
    public function updateByType(AccountRequest $accountRequest, bool $isEdit): bool
    {
     ...
     * @throws QueryException
     */
    public function deleteTypeByAccountId($id, bool $isEdit): int
    {
     ...
     * @throws QueryException
     */
    public function deleteByAccountId($id): int
    {
        $queryData = new QueryData();
