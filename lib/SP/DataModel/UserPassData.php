...
class UserPassData extends DataModelBase
{
     ...
     */
    public function setHashSalt($hashSalt): void
    {
     ...
     * @param string $mPass
     */
    public function setMPass($mPass): void
    {
        $this->mPass = $mPass;
    }
     ...
     * @param string $mKey
     */
    public function setMKey($mKey): void
    {
        $this->mKey = $mKey;
    }
     ...
     */
    public function setLastUpdateMPass($lastUpdateMPass): void
    {
