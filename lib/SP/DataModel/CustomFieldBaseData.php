...
class CustomFieldBaseData extends DataModelBase
{
     ...
     */
    public function setCustomfielddataId($customfielddata_id): void
    {
     ...
     */
    public function setCustomfielddefId($customfielddef_id): void
    {
     ...
     */
    public function setCustomfielddataData($customfielddata_data): void
    {
     ...
     */
    public function setCustomfielddataKey($customfielddata_key): void
    {
     ...
     */
    public function setCustomfielddefField($customfielddef_field): void
    {
