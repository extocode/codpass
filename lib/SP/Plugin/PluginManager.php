...
final class PluginManager
{
    ...
    private readonly \SP\Services\Plugin\PluginService $pluginService;

    private readonly \SP\Core\Events\EventDispatcher $eventDispatcher;

    private readonly \SP\Services\Plugin\PluginDataService $pluginDataService;
