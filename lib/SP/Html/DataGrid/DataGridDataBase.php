...
abstract class DataGridDataBase implements DataGridDataInterface
{
     ...
     * @param bool     $truncate
     */
    public function addDataRowSource($source, $isMethod = false, ?callable $filter = null, $truncate = true): void
    {
        $this->sources[] = [
            'name' => $source,
            'isMethod' => $isMethod,
     ...
     * @param $id string
     */
    public function setDataRowSourceId($id): void
    {
        $this->sourceId = $id;
    }
     ...
     */
    public function addDataRowSourceWithIcon($source, IconInterface $icon, $value = 1): void
    {
