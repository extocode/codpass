...
abstract class Cookie
{
     ...
     * @return string
     */
    final public function sign($data, $cypher)
    {
     ...
     * @return bool|string
     */
    final public function getCookieData($data, $cypher)
    {
    ...
    protected function setCookie($data)
    {
        ...
        return setcookie($this->cookieName, (string) $data, ['expires' => 0, 'path' => Bootstrap::$WEBROOT]);
    }
}
