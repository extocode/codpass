...
abstract class ContextBase implements ContextInterface
{
    ...
    private ?\SP\Core\Context\ContextCollection $context = null;

    private readonly \SP\Core\Context\ContextCollection $trasient;
     ...
     * @throws ContextException
     */
    final protected function setContextReference(array &$context)
    {
