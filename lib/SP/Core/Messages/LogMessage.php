...
final class LogMessage extends MessageBase
{
     ...
     * @return $this
     */
    public function addDetails($key, $value): self
    {
        if ($value === '' || $key === '') {
            return $this;
        }
     ...
     * @return $this
     */
    public function addDescription($description = ''): self
    {
     ...
     */
    public function addDescriptionLine(): self
    {
        $this->description[] = '';
     ...
     */
    public function composeText($delimiter = PHP_EOL): string
    {
     ...
     */
    public function resetDescription(): self
    {
        $this->description = [];
     ...
     */
    public function resetDetails(): self
    {
        $this->details = [];
