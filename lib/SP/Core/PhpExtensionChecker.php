...
final class PhpExtensionChecker
{
    ...
    {
        $missing = array_filter(self::EXTENSIONS, fn($v, $k): bool => $v === true && !in_array($k, $this->available), ARRAY_FILTER_USE_BOTH);
    ...
    {
        return array_filter(self::EXTENSIONS, fn($k): bool => !in_array($k, $this->available), ARRAY_FILTER_USE_KEY);
    }
}
