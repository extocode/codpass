...
interface AppInfoInterface
{
    public const APP_NAME = 'codPass';

    public const APP_DESC = 'COD Password Manager';
    ...
    public const APP_ISSUES_URL = 'https://git.extoco.de/lukas.parzinger/syspass-v4/-/issues';
}
