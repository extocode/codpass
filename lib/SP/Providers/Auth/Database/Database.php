...
final class Database implements AuthInterface
{
    ...
    private readonly \SP\Services\User\UserService $userService;

    private readonly \SP\Services\User\UserPassService $userPassService;
     ...
     */
    public function authenticate(UserLoginData $userLoginData): \SP\Providers\Auth\Database\DatabaseAuthData
    {
