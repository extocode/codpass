 ...
 */
final readonly class Browser implements AuthInterface
{
    private \SP\Config\ConfigData $configData;

    private \SP\Http\Request $request;
     ...
     */
    public function checkServerAuthUser($login): ?true
    {
    ...
    protected function getAuthPass()
    {
        ...
        return empty($authPass) ? null : $authPass;
    }
}
