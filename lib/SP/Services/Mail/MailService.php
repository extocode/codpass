...
final class MailService extends Service
{
     ...
     */
    public function check(MailParams $mailParams, $to): void
    {
        try {
     ...
     * @throws ServiceException
     */
    public function send($subject, $to, MailMessage $mailMessage): void
    {
        $this->mailer->isHTML();
        ...
        try {
            ...
            $this->eventDispatcher->notifyEvent(
                ...
                new Event($this, EventMessage::factory()
                    ...
                    ->addDetail(__u('Recipient'), implode(',', array_map(fn(array $value) => $value[0], $this->mailer->getToAddresses()))))
            );
        } catch (Exception $e) {
            processException($e);
     ...
     * @throws ServiceException
     */
    public function sendBatch($subject, array $to, MailMessage $mailMessage): void
    {
        $this->mailer->isHTML();
    ...
    public function getParamsFromConfig(): \SP\Providers\Mail\MailParams
    {
