...
final class UserPassResponse
{
     ...
     */
    public function setCryptMasterPass($cryptMasterPass): void
    {
     ...
     */
    public function setCryptSecuredKey($cryptSecuredKey): void
    {
     ...
     */
    public function setClearMasterPass($clearMasterPass): void
    {
