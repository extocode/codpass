...
final class UserService extends Service
{
    ...
    public static function mapUserLoginResponse(UserData $userData)
    {
        return (new UserLoginResponse())->setId($userData->getId())
            ...
            ->setLastUpdate($userData->getLastUpdate() !== null ? (int) strtotime($userData->getLastUpdate()) : 0);
    }
     ...
     * @throws ServiceException
     */
    public function updatePass($userId, $pass): void
    {
     ...
     * @throws QueryException
     */
    public function updatePreferencesById($userId, UserPreferencesData $userPreferencesData): int
    {
     ...
     * @throws QueryException
     */
    public function getUserEmailForGroup($groupId): array
    {
     ...
     * @throws QueryException
     */
    public function getUsageForUser($id): array
    {
