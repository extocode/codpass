...
final class NotificationService extends Service
{
    ...
    {
        return (int) $this->notificationRepository->create($itemData)->getLastId();
    }
     ...
     * @throws NoSuchItemException
     */
    public function deleteAdmin($id): self
    {
     ...
     * @throws NoSuchItemException
     */
    public function setCheckedById($id): void
    {
     ...
     * @throws QueryException
     */
    public function getForUserIdByDate($component, $id): array
    {
     ...
     * @throws QueryException
     */
    public function getAllForUserId($id): array
    {
     ...
     * @throws QueryException
     */
    public function getAllActiveForUserId($id): array
    {
