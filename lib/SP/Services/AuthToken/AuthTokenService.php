...
final class AuthTokenService extends Service
{
     ...
     * @throws QueryException
     */
    public function create(\SP\DataModel\AuthTokenData $itemData): int
    {
     ...
     * @throws QueryException
     */
    private function injectSecureData(AuthTokenData $authTokenData, $token = null): AuthTokenData
    {
        if ($token === null) {
     ...
     * @throws CryptoException
     */
    private function getSecureData(string $token, string $key)
    {
    ...
    {
        $this->transactionAware(function () use ($itemData): void {
     ...
     * @throws QueryException
     */
    public function update(AuthTokenData $itemData, $token = null): void
    {
