...
final class UserPassRecoverService extends Service
{
     ...
     */
    public const MAX_PASS_RECOVER_TIME = 3600;
    ...
    public const USER_LOGIN_EXIST = 1;

    public const USER_MAIL_EXIST = 2;
     ...
     * @param $hash
     */
    public static function getMailMessage(string $hash): \SP\Core\Messages\MailMessage
    {
     ...
     * @throws SPException
     */
    public function toggleUsedByHash($hash): void
    {
     ...
     * @throws QueryException
     */
    public function checkAttemptsByUserId($userId): bool
    {
     ...
     * @throws QueryException
     */
    public function add($userId, $hash): int
    {
     ...
     * @throws QueryException
     */
    public function getUserIdForHash($hash): int
    {
