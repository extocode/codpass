...
final class Task
{
    ...
    private ?\SP\Storage\File\FileHandler $fileOut = null;

    private ?\SP\Storage\File\FileHandler $fileTask = null;
     ...
     * @param $name
     */
    public static function genTaskId($name): string
    {
        return uniqid((string) $name);
    }
     ...
     * @throws FileException
     */
    public function registerSession(): self
    {
