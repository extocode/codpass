...
final class ApiService extends Service
{
     ...
     * @throws Exception
     */
    public function setup($actionId): void
    {
     ...
     * @param string $action
     */
    public function getHelp($action): array
    {
     ...
     * @throws ServiceException
     */
    private function accessDenied(): never
    {
        $this->addTracking();
    ...
    private function getMasterPassFromVault()
    {
        try {
            ...
            if (!Hash::checkHashKey($tokenPass, $this->authTokenData->getHash())) {
                $this->accessDenied();
            }
     ...
     * @throws ServiceException
     */
    public function getParamInt($param, $required = false, $default = null): int
    {
     ...
     * @throws ServiceException
     */
    public function getParamString($param, $required = false, $default = null): string
    {
     ...
     * @throws ServiceException
     */
    public function getParamArray($param, $required = false, $default = null): ?array
    {
     ...
     * @throws ServiceException
     */
    public function getParamEmail($param, $required = false, $default = null): string
    {
     ...
     * @throws ServiceException
     */
    public function getParamRaw($param, $required = false, $default = null): string
    {
    ...
    public function setApiRequest(ApiRequest $apiRequest): self
    {
