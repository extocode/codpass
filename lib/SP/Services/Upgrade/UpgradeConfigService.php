...
final class UpgradeConfigService extends Service implements UpgradeInterface
{
     ...
     */
    public function upgradeOldConfigFile($version): void
    {
        ...
        if (isset($CONFIG) && is_array($CONFIG)) {
            $paramMapper = function ($mapFrom, $mapTo) use ($CONFIG, $message, $configData): void {
            ...
            foreach ($this->getConfigParams() as $mapTo => $mapFrom) {
    ...
    private function getConfigParams(): array
    {
        return [
            ...
            'setWikiPageUrl' => ['wikipageurlwiki_pageurl'],
     ...
     */
    public function upgrade($version, ConfigData $configData): void
    {
     ...
     * @throws FileException
     */
    private function upgrade_200_17011202($version): void
    {
     ...
     * @throws FileException
     */
    private function upgrade_300_18111001($version): void
    {
        ...
        foreach ($extensions as $extension) {
            ...
            foreach ($mimeTypes as $mimeType) {
                if (strtolower((string) $mimeType['extension']) === $extension) {
     ...
     * @throws FileException
     */
    private function upgrade_300_18112501($version): void
    {
