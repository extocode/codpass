...
final class CustomFieldService extends Service
{
     ...
     * @param $name
     */
    public static function getFormIdForName($name): string
    {
        return 'cf_' . strtolower((string) preg_replace('/\W*/', '', (string) $name));
    }
     ...
     */
    public function getForModuleAndItemId($moduleId, $itemId): array
    {
     ...
     * @throws SPException
     */
    public function deleteCustomFieldData($itemId, $moduleId, $definitionId = null): int
    {
     ...
     * @throws ServiceException
     */
    protected function setSecureData(CustomFieldData $customFieldData, $key = null): void
    {
     ...
     * @throws ConstraintException
     */
    public function updateMasterPass(CustomFieldData $customFieldData, $masterPass): int
    {
