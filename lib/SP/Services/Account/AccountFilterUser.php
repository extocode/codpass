...
final class AccountFilterUser
{
    ...
    private readonly \SP\Core\Context\ContextInterface $context;
     ...
     */
    public function getFilterHistory($useGlobalSearch = false): \SP\Mvc\Model\QueryCondition
    {
        $this->setUp();
     ...
     * @param bool $useGlobalSearch
     */
    public function getFilter($useGlobalSearch = false): \SP\Mvc\Model\QueryCondition
    {
        $this->setUp();
