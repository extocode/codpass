...
final class AccountHistoryService extends Service
{
    ...
    {
        return $this->mapHistoryForDateSelect($this->accountHistoryRepository->getHistoryForAccount($id)->getDataAsArray());
    }
     ...
     *
     */
    private function mapHistoryForDateSelect(array $history): array
    {
        $items = [];
     ...
     * @throws ConstraintException
     */
    public function getUsersByAccountId($id): array
    {
     ...
     * @throws ConstraintException
     */
    public function getUserGroupsByAccountId($id): array
    {
    ...
    {
        return $this->accountHistoryRepository->deleteByClientIdBatch($ids);
    }
