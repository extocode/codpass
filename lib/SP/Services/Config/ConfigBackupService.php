...
final class ConfigBackupService extends Service
{
    ...
    public static function configToXml(string $configData): never
    {
     ...
     */
    public function backup(ConfigData $configData): void
    {
        try {
    ...
    private function packConfigData(ConfigData $configData): string
    {
