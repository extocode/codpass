...
final class PublicLinkService extends Service
{
     ...
     * @param $hash
     */
    public static function getLinkForHash($baseUrl, string $hash): string
    {
     ...
     * @throws EnvironmentIsBrokenException
     */
    public function getPublicLinkKey(?string $hash = null): \SP\Services\PublicLink\PublicLinkKey
    {
     ...
     * @return int
     */
    public static function calcDateExpire(Config $config): float|int
    {
     ...
     *
     */
    public static function getUseInfo($hash, Request $request): array
    {
        return [
