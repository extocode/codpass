...
final class ErrorUtil
{
     ...
     * @param bool     $render
     */
    public static function showErrorInView(Template $view, $type, $render = true, ?string $replace = null): void
    {
    ...
    private static function addErrorTemplate(Template $view, ?string $replace = null): void
    {
        if ($replace === null) {
            $view->resetTemplates();
        ...
        } elseif ($view->hashContentTemplates()) {
