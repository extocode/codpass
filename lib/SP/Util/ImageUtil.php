 ...
 * @package SP
 */
final readonly class ImageUtil
{
    /**
     ...
     */
    public function createThumbnail($image): string
    {
     ...
     */
    public function convertText($text): false|string
    {
        ...
        // Crear el texto
        imagettftext($im, 10, 0, 10, 20, $fgColor, $font, (string) $text);
