...
final class ArrayUtil
{
     ...
     * @param mixed  $value
     */
    public static function checkInObjectArrayMethod(array $objectArray, $method, $value): bool
    {
     ...
     * @param mixed  $value
     */
    public static function checkInObjectArray(array $objectArray, $property, $value): bool
    {
        if ($objectArray === []) {
            return false;
        }
