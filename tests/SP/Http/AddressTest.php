...
class AddressTest extends TestCase
{
     ...
     * @return array
     */
    public static function binaryCheckProvider()
    {
     ...
     * @return array
     */
    public static function checkAddressProvider()
    {
        return [
     ...
     * @return array
     */
    public static function checkAddressCidrProvider()
    {
        return [
     ...
     * @return array
     */
    public static function checkCidrProvider()
    {
        return [
            [32, '255.255.255.255'],
            [31, '255.255.255.254'],
