...
final class AccountController extends ControllerBase
{
    ...
    public function searchAction(): void
    {
        try {
            ...
            $accountSearchFilter->setLimitStart($this->apiService->getParamInt('offset', false, 0));
            $accountSearchFilter->setGlobalSearch((bool)$this->apiService->getParamInt('gsearch', false, 1));
