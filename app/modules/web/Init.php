...
final class Init extends ModuleBase
{
     ...
     */
    public const NO_SESSION_ACTIVITY = ['items', 'login'];
     ...
     * @throws Exception
     */
    public function initialize($controller): void
    {
        logger(__METHOD__);
     ...
     * @throws Exception
     */
    private function initSession($encrypt = false): void
    {
        if ($encrypt === true
