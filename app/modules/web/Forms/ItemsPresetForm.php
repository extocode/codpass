...
final class ItemsPresetForm extends FormBase implements FormInterface
{
     ...
     */
    public function validate($action): self
    {
        switch ($action) {
    ...
    protected function analyzeRequestData(): void
    {
        ...
        $this->itemPresetRequest = match ($itemPresetData->getType()) {
            ItemPresetInterface::ITEM_TYPE_ACCOUNT_PERMISSION => new ItemPresetRequest($itemPresetData, $this->makePermissionPreset()),
            ItemPresetInterface::ITEM_TYPE_ACCOUNT_PRIVATE => new ItemPresetRequest($itemPresetData, $this->makePrivatePreset()),
            ItemPresetInterface::ITEM_TYPE_SESSION_TIMEOUT => new ItemPresetRequest($itemPresetData, $this->makeSessionTimeoutPreset()),
            ItemPresetInterface::ITEM_TYPE_ACCOUNT_PASSWORD => new ItemPresetRequest($itemPresetData, $this->makePasswordPreset()),
            default => throw new ValidationException(__u('Value type not set or incorrect')),
        };
    }
     ...
     * @throws ValidationException
     */
    private function makePermissionPreset(): \SP\DataModel\ItemPreset\AccountPermission
    {
    ...
    private function makePrivatePreset(): \SP\DataModel\ItemPreset\AccountPrivate
    {
     ...
     * @throws ValidationException
     */
    private function makeSessionTimeoutPreset(): \SP\DataModel\ItemPreset\SessionTimeout
    {
        try {
     ...
     * @throws ValidationException
     */
    private function makePasswordPreset(): \SP\DataModel\ItemPreset\Password
    {
