...
final class LayoutHelper extends HelperBase
{
     ...
     * @param Acl    $acl
     */
    public function getFullLayout($page, ?Acl $acl = null): self
    {
        ...
        if ($acl instanceof \SP\Core\Acl\Acl) {
            $this->getMenu($acl);
        }
    ...
    public function initBody(): void
    {
        ...
        // codPass logos
        $this->view->assign('logo_icon', $baseUrl . '/public/images/codPass-favicon.png');
        $this->view->assign('logo_no_bg_color', $baseUrl . '/public/images/codPass-without-words.png');
        $this->view->assign('logo_no_bg', $baseUrl . '/public/images/codPass-big.png');
     ...
     * @param string $page Page/view name
     */
    public function getPublicLayout($template, $page = ''): self
    {
        $this->view->addTemplate('main', '_layouts');
     ...
     * @param string $page Page/view name
     */
    public function getCustomLayout($template, $page = ''): self
    {
        $this->view->addTemplate('main', '_layouts');
        $this->view->addContentTemplate($template);
