...
final class AccountHistoryHelper extends HelperBase
{
     ...
     */
    public function setView(AccountHistoryData $accountHistoryData, $actionId): void
    {
        ...
        $this->view->assign('isModified', $accountHistoryData->getDateEdit() !== null && strtotime($accountHistoryData->getDateEdit()) !== false);
