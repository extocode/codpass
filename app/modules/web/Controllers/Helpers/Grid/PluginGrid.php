...
final class PluginGrid extends GridBase
{
    ...
    private function getEnableAction(): \SP\Html\DataGrid\Action\DataGridAction
    {
        $gridAction = new DataGridAction();
    ...
    private function getDisableAction(): \SP\Html\DataGrid\Action\DataGridAction
    {
        $gridAction = new DataGridAction();
    ...
    private function getResetAction(): \SP\Html\DataGrid\Action\DataGridAction
    {
        $gridAction = new DataGridAction();
