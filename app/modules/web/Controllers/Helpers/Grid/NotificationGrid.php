...
{
    private ?\SP\Storage\Database\QueryResult $queryResult = null;
    ...
    protected function getData(): DataGridData
    {
        ...
        $gridData->addDataRowSource(
            'date',
            false,
            fn($value) => DateUtil::getDateFromUnix($value)
        );
        $gridData->addDataRowSource('type');
        $gridData->addDataRowSource('component');
        $gridData->addDataRowSource('description', false, fn(string $data): string => Html::stripTags($data));
    ...
    private function getSearchAction(): \SP\Html\DataGrid\Action\DataGridActionSearch
    {
        // Grid Actions
    ...
    private function getCreateAction(): \SP\Html\DataGrid\Action\DataGridAction
    {
    ...
    private function getViewAction(): \SP\Html\DataGrid\Action\DataGridAction
    {
        $gridAction = new DataGridAction();
    ...
    private function getCheckAction(): \SP\Html\DataGrid\Action\DataGridAction
    {
        $gridAction = new DataGridAction();
    ...
    private function getEditAction(): \SP\Html\DataGrid\Action\DataGridAction
    {
        $gridAction = new DataGridAction();
    ...
    private function getDeleteAction(): \SP\Html\DataGrid\Action\DataGridAction
    {
        $gridAction = new DataGridAction();
