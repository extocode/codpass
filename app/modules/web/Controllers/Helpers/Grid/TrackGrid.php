...
final class TrackGrid extends GridBase
{
    ...
    private function getRefrestAction(): \SP\Html\DataGrid\Action\DataGridAction
    {
    ...
    private function getClearAction(): \SP\Html\DataGrid\Action\DataGridAction
    {
        $gridAction = new DataGridAction();
    ...
    private function getUnlockAction(): \SP\Html\DataGrid\Action\DataGridAction
    {
        $gridAction = new DataGridAction();
