...
final class FileGrid extends GridBase
{
    ...
    protected function getData(): DataGridData
    {
        ...
        $gridData->addDataRowSource('size', false, fn($value): string => sprintf('%.2f KB', $value / 1000));
    ...
    private function getDownloadAction(): \SP\Html\DataGrid\Action\DataGridAction
    {
        $gridAction = new DataGridAction();
        ...
        $gridAction->setRuntimeData(fn($dataItem): array => ['item-type' => $dataItem->type]);
