...
final class ItemPresetGrid extends GridBase
{
    ...
    private function getCreatePermissionAction(): \SP\Html\DataGrid\Action\DataGridAction
    {
    ...
    private function getCreatePrivateAction(): \SP\Html\DataGrid\Action\DataGridAction
    {
        $gridAction = new DataGridAction();
        $gridAction->setId(ActionsInterface::ITEMPRESET_CREATE);
        $gridAction->setType(DataGridActionType::MENUBAR_ITEM);
    ...
    private function getCreateSessionTimeoutAction(): \SP\Html\DataGrid\Action\DataGridAction
    {
        $gridAction = new DataGridAction();
        $gridAction->setId(ActionsInterface::ITEMPRESET_CREATE);
        $gridAction->setType(DataGridActionType::MENUBAR_ITEM);
    ...
    private function getCreateAccountPasswordAction(): \SP\Html\DataGrid\Action\DataGridAction
    {
        $gridAction = new DataGridAction();
        $gridAction->setId(ActionsInterface::ITEMPRESET_CREATE);
        $gridAction->setType(DataGridActionType::MENUBAR_ITEM);
