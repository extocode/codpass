...
final class ConfigGeneralController extends SimpleControllerBase
{
    ...
    public function saveAction()
    {
        ...
        $configData->setLogEvents($this->request->analyzeArray('log_events', fn(array $items) => ConfigUtil::eventsAdapter($items), []));
        ...
        return $this->saveConfig(
            $configData,
            $this->config,
            function () use ($eventMessage, $configData): void {
    ...
    public function downloadConfigBackupAction($type)
    {
        ...
        try {
            ...
            $data = match ($type) {
                'json' => ConfigBackupService::configToJson($configBackupService->getBackup()),
