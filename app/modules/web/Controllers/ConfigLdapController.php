...
final class ConfigLdapController extends SimpleControllerBase
{
    ...
    public function saveAction()
    {
        try {
            ...
            return $this->saveConfig($configData, $this->config, function () use ($eventMessage): void {
     ...
     */
    protected function getLdapParamsFromRequest(): \SP\Providers\Auth\Ldap\LdapParams
    {
