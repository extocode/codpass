...
final class AccountController extends ControllerBase implements CrudControllerInterface
{
     ...
     * @throws NotFoundExceptionInterface
     */
    public function viewLinkAction($hash): void
    {
        try {
     ...
     * @throws NotFoundExceptionInterface
     */
    public function copyAction($id): void
    {
        try {
            $this->checkSecurityToken($this->previousSk, $this->request);
     ...
     * @throws NotFoundExceptionInterface
     */
    public function editPassAction($id): void
    {
        try {
            $this->checkSecurityToken($this->previousSk, $this->request);
     ...
     * @throws NotFoundExceptionInterface
     */
    public function viewHistoryAction($id): void
    {
        try {
            $this->checkSecurityToken($this->previousSk, $this->request);
     ...
     * @throws NotFoundExceptionInterface
     */
    public function requestAccessAction($id): void
    {
        try {
            $this->checkSecurityToken($this->previousSk, $this->request);
     ...
     * @return bool
     */
    public function saveRequestAction(string $id)
    {
        try {
            $this->checkSecurityToken($this->previousSk, $this->request);
            ...
            $this->eventDispatcher->notifyEvent(
                ...
                new Event($this, EventMessage::factory()
                    ...
                    ->setExtra('email', array_map(fn($value) => $value->email, $userService->getUserEmailById($usersId))))
            );
