...
final class AccountFileController extends ControllerBase implements CrudControllerInterface
{
    ...
    public const MIME_VIEW = ['text/plain'];
     ...
     * @param $id
     */
    public function downloadAction($id): string
    {
        try {
            $this->checkSecurityToken($this->previousSk, $this->request);
     ...
     * @param $id
     */
    public function editAction($id): never
    {
        throw new RuntimeException('Not implemented');
    }
     ...
     * Saves create action
     */
    public function saveCreateAction(): never
    {
        throw new RuntimeException('Not implemented');
    }
     ...
     * @param $id
     */
    public function saveEditAction($id): never
    {
        throw new RuntimeException('Not implemented');
    }
     ...
     */
    public function listAction($accountId): void
    {
        ...
        try {
            ...
            $this->view->assign('deleteEnabled', $this->request->analyzeInt('del', 0));
