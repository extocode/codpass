...
final class SecurityManagerController extends ControllerBase
{
    ...
    protected function getGridTabs(): void
    {
        ...
        // Debug info
        $debugInfo = [
            'isAdmin' => $this->userData->getIsAdminApp(),
            'hasEventlogAccess' => $this->checkAccess(Acl::EVENTLOG),
            'isLogEnabled' => $this->configData->isLogEnabled(),
            'hasTrackAccess' => $this->checkAccess(Acl::TRACK),
        ];
        ...
        $this->view->assign('debugInfo', $debugInfo);
        $this->view();
    }
