...
trait ItemTrait
{
     ...
     */
    protected function getCustomFieldsForItem($moduleId, $itemId): array
    {
    ...
    {
        $customFields = $request->analyzeArray('customfield', fn($values): array => array_map(Filter::getString(...), $values));
     ...
     */
    protected function getSearchData(?int $limitCount, Request $request): \SP\DataModel\ItemSearchData
    {
